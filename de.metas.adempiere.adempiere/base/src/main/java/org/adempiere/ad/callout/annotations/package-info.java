 ...
 *
 * Using the annotations, it is possible to use callouts "programmatically only", without the need to register them in the database's application dictionary.<br>
 * <p>
 ...
 * <p>
 * The preferred way to register callouts is by extending {@link org.adempiere.ad.modelvalidator.AbstractModuleInterceptor} and overriding its <code>registerCallouts()</code> method.
 * <p>
