...
{
	public static final M_MatchInv INSTANCE = new M_MatchInv();
	...
	/**
	 * Note that we need the C_Invoice_ID for be set, because in the "Eingangsrechnung" (PO-Invoice) window, the invoice lines are in an included tab, so the matchInv tab is a subtab of the C_Invoice
	 * tab.
	 *
	 * @param matchInv
	 */
